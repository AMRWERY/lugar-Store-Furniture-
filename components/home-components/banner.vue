<template>
  <div>
    <div class="relative w-full bg-center bg-cover hero-section" :style="{ backgroundImage: `url(${heroImage})` }" data-aos="fade-left">
...
<script setup>
const heroImage = 'https://justfields.com/storage/projects/7M5rV059/banner.jpg';
</script>
